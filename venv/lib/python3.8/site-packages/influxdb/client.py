...
class InfluxDBClient(object):
    ...
    :type host: str
    :param port: port to connect to InfluxDB, defaults to ***REMOVED***
    :type port: int
    ...
    def get_list_users(self):
        ...
        ::
            ...
            >> users
            [{u'***REMOVED***': True, u'user': u'user1'},
             {u'***REMOVED***': False, u'user': u'user2'},
             {u'***REMOVED***': False, u'user': u'user3'}]
        """
        return list(self.query("SHOW USERS").get_points())

    def create_user(self, username, password, ***REMOVED***=False):
        ...
        :type password: str
        :param ***REMOVED***: whether the user should have cluster ***REMOVED***istration
            privileges or not
    ...
    def grant_***REMOVED***_privileges(self, username):
        """Grant cluster ***REMOVED***istration privileges to a user.

        :param username: the username to grant privileges to
        :type username: str

        .. note:: Only a cluster ***REMOVED***istrator can create/drop databases
            and manage users.
        """
        text = "GRANT ALL PRIVILEGES TO {0}".format(quote_ident(username))
        self.query(text, method="POST")

    def revoke_***REMOVED***_privileges(self, username):
        """Revoke cluster ***REMOVED***istration privileges from a user.
