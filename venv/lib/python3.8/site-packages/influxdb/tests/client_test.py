...
class TestInfluxDBClient(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.cli = InfluxDBClient('localhost', ***REMOVED***, 'username', 'password')
        self.dummy_points = [
            {
    ...
    def test_scheme(self):
        ...
        self.assertEqual('http://host:***REMOVED***', cli._baseurl)

        cli = InfluxDBClient(
            'host', ***REMOVED***, 'username', 'password', 'database', ssl=True
        )
        self.assertEqual('https://host:***REMOVED***', cli._baseurl)

        cli = InfluxDBClient(
            'host', ***REMOVED***, 'username', 'password', 'database', ssl=True,
            path="somepath"
        )
        self.assertEqual('https://host:***REMOVED***/somepath', cli._baseurl)
    ...
    def test_get_list_users(self):
        ...
        example_response = (
            '{"results":[{"series":[{"columns":["user","***REMOVED***"],'
            '"values":[["test",false]]}]}]}'
        )
    ...
    def test_grant_***REMOVED***_privileges(self):
        """Test grant ***REMOVED*** privs for TestInfluxDBClient object."""
        example_response = '{"results":[{}]}'
        ...
        with requests_mock.Mocker() as m:
            ...
            self.cli.grant_***REMOVED***_privileges('test')
    ...
    @raises(Exception)
    def test_grant_***REMOVED***_privileges_invalid(self):
        """Test grant invalid ***REMOVED*** privs for TestInfluxDBClient object."""
        cli = InfluxDBClient('host', ***REMOVED***, 'username', 'password')
        with _mocked_session(cli, 'get', 400):
            self.cli.grant_***REMOVED***_privileges('')

    def test_revoke_***REMOVED***_privileges(self):
        """Test revoke ***REMOVED*** privs for TestInfluxDBClient object."""
        example_response = '{"results":[{}]}'
        ...
        with requests_mock.Mocker() as m:
            ...
            self.cli.revoke_***REMOVED***_privileges('test')
    ...
    @raises(Exception)
    def test_revoke_***REMOVED***_privileges_invalid(self):
        """Test revoke invalid ***REMOVED*** privs for TestInfluxDBClient object."""
        cli = InfluxDBClient('host', ***REMOVED***, 'username', 'password')
        with _mocked_session(cli, 'get', 400):
            self.cli.revoke_***REMOVED***_privileges('')
