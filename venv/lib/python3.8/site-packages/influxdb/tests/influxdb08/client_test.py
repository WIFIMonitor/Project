...
class TestInfluxDBClient(unittest.TestCase):
    ...
    def test_scheme(self):
        ...
        cli = InfluxDBClient('host', ***REMOVED***, 'username', 'password', 'database')
        self.assertEqual(cli._baseurl, 'http://host:***REMOVED***')

        cli = InfluxDBClient(
            'host', ***REMOVED***, 'username', 'password', 'database', ssl=True
        )
        self.assertEqual(cli._baseurl, 'https://host:***REMOVED***')
    ...
    def test_write_points(self):
        ...
        with requests_mock.Mocker() as m:
            m.register_uri(
                requests_mock.POST,
                "http://localhost:***REMOVED***/db/db/series"
            )
    ...
    def test_write_points_batch(self):
        ...
        with requests_mock.Mocker() as m:
            m.register_uri(requests_mock.POST,
                           "http://localhost:***REMOVED***/db/db/series")
            cli = InfluxDBClient('localhost', ***REMOVED***,
    ...
    def test_write_points_fails(self):
        ...
        with _mocked_session('post', 500):
            cli = InfluxDBClient('host', ***REMOVED***, 'username', 'password', 'db')
            cli.write_points([])
    ...
    def test_delete_points(self):
        ...
        with _mocked_session('delete', 204) as mocked:
            ...
            self.assertEqual(kwds['url'], 'http://host:***REMOVED***/db/db/series/foo')
    ...
    def test_get_list_database(self):
        ...
        with _mocked_session('get', 200, data):
            cli = InfluxDBClient('host', ***REMOVED***, 'username', 'password')
    ...
    def test_get_list_cluster_***REMOVED***s(self):
        """Test get list of cluster ***REMOVED***s, not implemented."""
        pass

    def test_add_cluster_***REMOVED***(self):
        """Test add cluster ***REMOVED*** for TestInfluxDBClient."""
        with requests_mock.Mocker() as m:
            m.register_uri(
                requests_mock.POST,
                "http://localhost:***REMOVED***/cluster_***REMOVED***s"
            )

            cli = InfluxDBClient(database='db')
            cli.add_cluster_***REMOVED***(
                new_username='paul',
                new_password='laup'
            )
    ...
    def test_update_cluster_***REMOVED***_password(self):
        """Test update cluster ***REMOVED*** pass for TestInfluxDBClient."""
        with requests_mock.Mocker() as m:
            m.register_uri(
                requests_mock.POST,
                "http://localhost:***REMOVED***/cluster_***REMOVED***s/paul"
            )

            cli = InfluxDBClient(database='db')
            cli.update_cluster_***REMOVED***_password(
                username='paul',
                new_password='laup'
            )
    ...
    def test_delete_cluster_***REMOVED***(self):
        """Test delete cluster ***REMOVED*** for TestInfluxDBClient."""
        with requests_mock.Mocker() as m:
            m.register_uri(
            ...
            cli = InfluxDBClient(database='db')
            cli.delete_cluster_***REMOVED***(username='paul')

            self.assertIsNone(m.last_request.body)

    def test_set_database_***REMOVED***(self):
        """Test set database ***REMOVED*** for TestInfluxDBClient."""
        pass

    def test_unset_database_***REMOVED***(self):
        """Test unset database ***REMOVED*** for TestInfluxDBClient."""
        pass

    def test_alter_database_***REMOVED***(self):
        """Test alter database ***REMOVED*** for TestInfluxDBClient."""
        with requests_mock.Mocker() as m:
            m.register_uri(
                requests_mock.POST,
                "http://localhost:***REMOVED***/db/db/users/paul"
            )

            cli = InfluxDBClient(database='db')
            cli.alter_database_***REMOVED***(
                username='paul',
                is_***REMOVED***=False
            )
    ...
    @raises(NotImplementedError)
    def test_get_list_database_***REMOVED***s(self):
        """Test get list of database ***REMOVED***s for TestInfluxDBClient."""
        cli = InfluxDBClient('host', ***REMOVED***, 'username', 'password', 'db')
        cli.get_list_database_***REMOVED***s()

    @raises(NotImplementedError)
    def test_add_database_***REMOVED***(self):
        """Test add database ***REMOVED***s for TestInfluxDBClient."""
        cli = InfluxDBClient('host', ***REMOVED***, 'username', 'password', 'db')
        cli.add_database_***REMOVED***('***REMOVED***', '***REMOVED***_secret_password')

    @raises(NotImplementedError)
    def test_update_database_***REMOVED***_password(self):
        """Test update database ***REMOVED*** pass for TestInfluxDBClient."""
        cli = InfluxDBClient('host', ***REMOVED***, 'username', 'password', 'db')
        cli.update_database_***REMOVED***_password('***REMOVED***', '***REMOVED***_secret_password')

    @raises(NotImplementedError)
    def test_delete_database_***REMOVED***(self):
        """Test delete database ***REMOVED*** for TestInfluxDBClient."""
        cli = InfluxDBClient('host', ***REMOVED***, 'username', 'password', 'db')
        cli.delete_database_***REMOVED***('***REMOVED***')

    def test_get_database_users(self):
        """Test get database users for TestInfluxDBClient."""
        cli = InfluxDBClient('localhost', ***REMOVED***, 'username', 'password', 'db')
        ...
        with requests_mock.Mocker() as m:
            m.register_uri(
                requests_mock.GET,
                "http://localhost:***REMOVED***/db/db/users",
                text=example_response
            )
    ...
    def test_update_database_user_password_current_user(self):
        ...
        with requests_mock.Mocker() as m:
            m.register_uri(
                requests_mock.POST,
                "http://localhost:***REMOVED***/db/database/users/root"
            )
