...
class SimpleTests(SingleTestCaseWithServerMixin, unittest.TestCase):
    ...
    def test_create_user(self):
        ...
        self.assertIn({'user': 'test_user', '***REMOVED***': False},
                      rsp)

    def test_create_user_***REMOVED***(self):
        """Test create ***REMOVED*** user."""
        self.cli.create_user('test_user', 'secret_password', True)
        rsp = list(self.cli.query("SHOW USERS")['results'])
        self.assertIn({'user': 'test_user', '***REMOVED***': True},
                      rsp)
    ...
    def test_revoke_***REMOVED***_privileges(self):
        """Test revoking ***REMOVED*** privs, deprecated as of v0.9.0."""
        self.cli.create_user('test', 'test', ***REMOVED***=True)
        self.assertEqual([{'user': 'test', '***REMOVED***': True}],
                         self.cli.get_list_users())
        self.cli.revoke_***REMOVED***_privileges('test')
        self.assertEqual([{'user': 'test', '***REMOVED***': False}],
                         self.cli.get_list_users())
