...
class TestDataFrameClient(unittest.TestCase):
    ...
    def test_get_list_database_fails(self):
        ...
        cli = DataFrameClient('host', ***REMOVED***, 'username', 'password')
    ...
    def test_query_into_dataframe(self):
        ...
        cli = DataFrameClient('host', ***REMOVED***, 'username', 'password', 'db')
    ...
    def test_dsn_constructor(self):
        ...
        client = DataFrameClient.from_dsn('influxdb://localhost:***REMOVED***')
        self.assertIsInstance(client, DataFrameClient)
        self.assertEqual('http://localhost:***REMOVED***', client._baseurl)
