...
class InfluxDBClient(object):
    ...
    # get list of deletes
    # curl http://localhost:***REMOVED***/db/site_dev/scheduled_deletes
    #
    # remove a regularly scheduled delete
    # curl -X DELETE http://localhost:***REMOVED***/db/site_dev/scheduled_deletes/:id
    ...
    #
    # ### create a database
    # curl -X POST http://localhost:***REMOVED***/db -d '{"name": "site_development"}'
    #
    # ### drop a database
    # curl -X DELETE http://localhost:***REMOVED***/db/site_development
    ...
    # curl -X GET http://localhost:***REMOVED***/db
    ...
    # Security
    # get list of cluster ***REMOVED***s
    # curl http://localhost:***REMOVED***/cluster_***REMOVED***s?u=root&p=root

    # add cluster ***REMOVED***
    # curl -X POST http://localhost:***REMOVED***/cluster_***REMOVED***s?u=root&p=root \
    #      -d '{"name": "paul", "password": "i write teh docz"}'

    # update cluster ***REMOVED*** password
    # curl -X POST http://localhost:***REMOVED***/cluster_***REMOVED***s/paul?u=root&p=root \
    #      -d '{"password": "new pass"}'

    # delete cluster ***REMOVED***
    # curl -X DELETE http://localhost:***REMOVED***/cluster_***REMOVED***s/paul?u=root&p=root

    # Database ***REMOVED***s, with a database name of site_dev
    # get list of database ***REMOVED***s
    # curl http://localhost:***REMOVED***/db/site_dev/***REMOVED***s?u=root&p=root

    # add database ***REMOVED***
    # curl -X POST http://localhost:***REMOVED***/db/site_dev/***REMOVED***s?u=root&p=root \
    #      -d '{"name": "paul", "password": "i write teh docz"}'

    # update database ***REMOVED*** password
    # curl -X POST http://localhost:***REMOVED***/db/site_dev/***REMOVED***s/paul?u=root&p=root\
    #      -d '{"password": "new pass"}'

    # delete database ***REMOVED***
    # curl -X DELETE \
    #        http://localhost:***REMOVED***/db/site_dev/***REMOVED***s/paul?u=root&p=root

    def get_list_cluster_***REMOVED***s(self):
        """Get list of cluster ***REMOVED***s."""
        response = self.request(
            url="cluster_***REMOVED***s",
            method='GET',
            expected_response_code=200
        )
    ...
    def add_cluster_***REMOVED***(self, new_username, new_password):
        """Add cluster ***REMOVED***."""
        data = {
            'name': new_username,
    ...
    def update_cluster_***REMOVED***_password(self, username, new_password):
        """Update cluster ***REMOVED*** password."""
        url = "cluster_***REMOVED***s/{0}".format(username)
    ...
    def delete_cluster_***REMOVED***(self, username):
        """Delete cluster ***REMOVED***."""
        url = "cluster_***REMOVED***s/{0}".format(username)
    ...
    def set_database_***REMOVED***(self, username):
        """Set user as database ***REMOVED***."""
        return self.alter_database_***REMOVED***(username, True)

    def unset_database_***REMOVED***(self, username):
        """Unset user as database ***REMOVED***."""
        return self.alter_database_***REMOVED***(username, False)

    def alter_database_***REMOVED***(self, username, is_***REMOVED***):
        """Alter the database ***REMOVED***."""
        url = "db/{0}/users/{1}".format(self._database, username)

        data = {'***REMOVED***': is_***REMOVED***}
    ...
    def get_list_database_***REMOVED***s(self):
        """Get list of database ***REMOVED***s.
    ...
    def add_database_***REMOVED***(self, new_username, new_password):
        """Add cluster ***REMOVED***.
    ...
    def update_database_***REMOVED***_password(self, username, new_password):
        """Update database ***REMOVED*** password.
    ...
    def delete_database_***REMOVED***(self, username):
        """Delete database ***REMOVED***.
    ...
    # curl http://localhost:***REMOVED***/db/site_dev/users?u=root&p=root

    # add database user
    # curl -X POST http://localhost:***REMOVED***/db/site_dev/users?u=root&p=root \
    #       -d '{"name": "paul", "password": "i write teh docz"}'

    # update database user password
    # curl -X POST http://localhost:***REMOVED***/db/site_dev/users/paul?u=root&p=root \
    #       -d '{"password": "new pass"}'

    # delete database user
    # curl -X DELETE http://localhost:***REMOVED***/db/site_dev/users/paul?u=root&p=root
